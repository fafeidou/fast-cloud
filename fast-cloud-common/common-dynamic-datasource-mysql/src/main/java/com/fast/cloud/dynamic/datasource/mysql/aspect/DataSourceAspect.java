...
package com.fast.cloud.dynamic.datasource.mysql.aspect;
...
public class DataSourceAspect {
    ...
    @Pointcut("@annotation(com.fast.cloud.dynamic.datasource.mysql.annotation.DataSource) " +
            "|| @within(com.fast.cloud.dynamic.datasource.mysql.annotation.DataSource)")
